...
plot(electric_consumption$DateTime,electric_consumption$Global_active_power,ylab='Global Active Power',xlab='',type='l')

# plot data on second quadrant
plot(electric_consumption$DateTime,electric_consumption$Voltage,xlab='datetime',ylab='Voltage',type='l')
...
plot(electric_consumption$DateTime,electric_consumption$Global_reactive_power,xlab='datetime',ylab='Global_reactive_power',type='l')
